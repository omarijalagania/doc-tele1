export default {
  ...
  auth: {
    ...
    toastEmail: 'A confirmation email has been sent and you will receive it shortly.',
    toastEmailError: 'An error occurred while sending your email',
    accountCreated: 'Please verify your account by clicking on the confirmation link.',
    toastDescription: 'Please try again and make sure you enter the correct email address.',
    unverifiedAccount: "If you don't receive the confirmation link, request a new one.",
    pleaseConfirm: 'Please confirm your email address by clicking on the confirmation link.',
    confirmEmailTitle: 'Confirm email',
    success: 'Registration completed successfully',
    usernameTaken: 'This username has already been taken',
    alphanumeric: 'Username can only contain alphanumeric characters and dashes.',
    errorOccurred: 'An error occurred',
    emailAlreadyExists:
      'User with this email already exists. Please use a different email address.',
    contact: 'Contact',
    welcome: 'Welcome to eSignix!',
    step: 'Step',
    about: 'About',
    pricing: 'Plans & Pricing',
    register: 'Sign up',
    join: 'Join us and sign in seconds. No credit card required',
    ge: 'Georgia',
    us: 'United States',
    useToday: 'Get start using today',
    name: 'Full Name',
    ...
    newPassword: 'Please choose your new password',
    newOldPassword: 'Your new password cannot be the same as your old password.',
    signInDesc: 'eSignix - Sign in Seconds!',
    resetEmailDesc: 'Password recovery link has been sent to your Email.',
    noPassword: 'Forgot your password?',
    noPasswordDesc: 'Enter your email and get password recovery link.',
    registerNow: 'Sign up',
    unableLogin: 'Unable to sign in',
    emailErrorMessage: 'The email or password provided is incorrect',
  },
  validation: {
